...
> [!NOTE]
> **关于原作者及二次开发声明**
> 本项目是基于原作者 **阿硕** 的公开源码项目 [AI-CanvasPro](https://github.com/ashuoAI/AI-CanvasPro) 进行的二次开发版本，仅用于个人学习和使用。在此对原作者的开源精神与优秀成果表示由衷的感谢！
>
> **授权与限制约束（重要）**
> 本修改版项目依然完全受原项目双许可证模式（[LICENSE](./LICENSE) 和 [COMMERCIAL-LICENSE.md](./COMMERCIAL-LICENSE.md)）的约束。在未获得原作者书面商业授权前，本项目源码及衍生版本仅限个人学习、研究、教学和非商业评估使用，禁止以任何形式用于商业用途、SaaS服务、收费分发或进行商业变现。
...
未经原作者单独书面授权，禁止将本项目或其衍生版本用于商业用途、SaaS、云服务、公开托管服务、收费服务、商业交付、外包交付、广告引流、会员订阅或其他直接/间接商业收益场景。

除原作者明确公布的地址外，任何第三方公开部署、镜像站点、托管服务或改版服务均为非官方行为，与原作者和作者无关；请勿在非官方站点输入 API Key、授权码或其他敏感信息。
...
1. **下载整合包**
   [点击下载](https://github.com/ashuoAI/AI-CanvasPro/releases) （请参考原作者 Release 页面）
2. **解压文件**
   将下载的压缩包解压到不带中文的路径，例如 `D:\manju`
3. **一键启动**
   直接双击 **`pilipulu.exe`** 文件即可（如有打包）
...
本项目基于 **阿硕** 的开源项目进行二次开发。在此向原作者表示由衷的感谢！
